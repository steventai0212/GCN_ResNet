...
def parse_args():
    ...
    parser.add_argument('--img_path', type=str, default='./celeba_val', help='original images folder')
    parser.add_argument('--save_path', type=str, default='./celeba_val_processed_data', help='custom path to save proccessed images and labels')
