...
class Option():
	def __init__(self,model_name=None,is_train=True):
		...
		# self.folder_name = 'model_gcn_id_label_lm'
		# self.pretrain_model = os.path.join('result/{}'.format(self.folder_name),'iter_{}.ckpt'.format(self.resume_iter))
		#---------------------------------------------------------------------------------------
